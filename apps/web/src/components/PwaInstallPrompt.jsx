...
export const PwaInstallPrompt = () => {
  ...
  return (
    <div className="fixed inset-x-0 bottom-4 z-50 px-4 sm:bottom-6 sm:px-6">
      <div className="mx-auto flex max-w-md items-end justify-between gap-3 rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-[0_16px_40px_rgba(15,23,42,0.14)] backdrop-blur">
        <div>
