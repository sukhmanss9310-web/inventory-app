...
export const env = {
  ...
  seedPlatformCompanyName: process.env.SEED_PLATFORM_COMPANY_NAME || "Platform Control",
  seedPlatformCompanyCode: process.env.SEED_PLATFORM_COMPANY_CODE || "platform",
  seedDeveloperEmail: process.env.SEED_DEVELOPER_EMAIL || "developer@ops.local",
  seedDeveloperPassword: process.env.SEED_DEVELOPER_PASSWORD || "Developer@123456",
